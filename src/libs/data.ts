export const BigDay = new Date('August 25, 2022 18:00:00')
export const months = [
    'January',
    'February',
    'March',
...
export const sectionHome = ['Info', 'Story']
export const sectionRSVP = ['Rsvp', 'Reception', 'Attire', 'Gallery']

export const attire = ['Semi-Formal', '(AKA Dressy Casual, or Cocktail)']
